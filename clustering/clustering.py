...
def plotVariableLatent(adata:ad.AnnData,cluster_key='leiden',method='wilcoxon',num_features=5,variable_names=adata.var_names) -> Tuple:
    """
    ...
    """
    P1 = sc.pl.dotplot(adata, var_names=variable_names, groupby=cluster_key)
